...
const TicketTaskSchema = new Schema(
  {
    ...
    status: { type: String, enum: ["TODO", "IN_PROGRESS", "PENDING_APPROVAL", "DONE", "CANCELLED"], default: "TODO", index: true },
    reminderMinutes: { type: [Number], default: [60, 15] },
    sentEvents: { type: [String], default: [] },
    completedAt: Date,
    resolutionText: { type: String, trim: true, maxlength: 3000 },
    submittedAt: Date,
    reviewComment: { type: String, trim: true, maxlength: 3000 },
    reviewedAt: Date,
