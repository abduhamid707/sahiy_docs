...
export const EditDocuments: React.FC<Props> = ({ form, setForm }) => {
  ...
  const handleFileUpload = async (
    ...
    try {
      ...
      toast.success(
        `${type === "front" ? "Old tomoni" : "Orqa tomoni"} muvaffaqiyatli yuklandi`
      );
    } catch (err: any) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              setForm({ ...form, passportSeries: e.target.value.toUpperCase() })
            }
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              setForm({ ...form, passportPinfl: e.target.value.replace(/\D/g, "") })
            }
        ...
        <div className="space-y-2">
          ...
          <DateInput
            ...
            onChange={(val) => setForm({ ...form, passportIssuedAt: val })}
        ...
        <div className="space-y-2">
          ...
          <DateInput
            ...
            onChange={(val) => setForm({ ...form, passportExpiresAt: val })}
          ...
          <div className="p-4 rounded-2xl border-2 border-dashed border-border flex flex-col items-center justify-center text-center gap-2 hover:border-blue-500/40 transition-all bg-muted/20">
            ...
            {form.passportFront ? (
              <div className="flex items-center gap-2 text-xs font-semibold text-emerald-600 bg-emerald-500/10 px-3 py-1.5 rounded-lg mt-1">
                ...
                <button
                  type="button"
                  onClick={() => setForm({ ...form, passportFront: null })}
          ...
          <div className="p-4 rounded-2xl border-2 border-dashed border-border flex flex-col items-center justify-center text-center gap-2 hover:border-blue-500/40 transition-all bg-muted/20">
            ...
            {form.passportBack ? (
              <div className="flex items-center gap-2 text-xs font-semibold text-emerald-600 bg-emerald-500/10 px-3 py-1.5 rounded-lg mt-1">
                ...
                <button
                  type="button"
                  onClick={() => setForm({ ...form, passportBack: null })}
                  className="text-rose-500 hover:text-rose-700 ml-1"
                >
                  <Trash2 className="w-3.5 h-3.5" />
                </button>
