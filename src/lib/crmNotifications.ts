...
type NotificationKind = "TICKET_ASSIGNED" | "TASK_ASSIGNED" | "TASK_APPROVAL_REQUESTED" | "TASK_APPROVED" | "TASK_REJECTED" | "ONE_HOUR_LEFT" | "FIFTEEN_MINUTES_LEFT" | "OVERDUE" | "CRITICAL" | "EXECUTIVE_REPORT" | "TICKET_APPROVAL_REQUESTED" | "TICKET_APPROVED" | "TICKET_RETURNED" | "CONSULTATION_REQUESTED" | "CONSULTATION_ANSWERED";
